"""
Django settings for moithils_7 project.
...
WSGI_APPLICATION = 'moithils_7.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "moithils_7 API",
    "DESCRIPTION": "API documentation for moithils_7 App",
    "VERSION": "v1",
}
